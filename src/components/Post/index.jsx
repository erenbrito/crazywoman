    ...
    return (
      <div className="post">
        <div className="post__meta">
          <time className="post__meta-time" dateTime={moment(post.date).locale('pt-BR').format('MMMM D, YYYY')}>
            {moment(post.date).locale('pt-BR').format('LL')}
          </time>
        ...
        <Link className="post__readmore" to={post.slug}>Chega mais</Link>
      </div>
    );
  }
}
